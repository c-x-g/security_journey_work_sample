...
Insecure Direct Object Reference (IDOR) is a security vulnerability where an unauthorized client is able to access an object (i.e. documents, data) they should not have access to
